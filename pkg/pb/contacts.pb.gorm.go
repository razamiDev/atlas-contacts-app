...
type ContactsListCustomHandler interface {
	CustomList(context.Context, *ListContactsRequest) (*ListContactsResponse, error)
}

// List ...
func (m *ContactsDefaultServer) List(ctx context.Context, in *ListContactsRequest) (*ListContactsResponse, error) {
...
type ContactsErrorExampleCustomHandler interface {
	CustomErrorExample(context.Context, *ErrorContactRequest) (*ErrorContactResponse, error)
}

// ErrorExample ...
func (m *ContactsDefaultServer) ErrorExample(ctx context.Context, in *ErrorContactRequest) (*ErrorContactResponse, error) {
	if custom, ok := interface{}(m).(ContactsErrorExampleCustomHandler); ok {
		return custom.CustomErrorExample(ctx, in)
	}
	return &ErrorContactResponse{}, nil
}
